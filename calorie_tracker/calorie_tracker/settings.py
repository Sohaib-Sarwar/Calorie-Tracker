...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-calorie-tracker-secret-key-example')
...
INSTALLED_APPS = [
    ...
    'tracker',  # Our calorie tracker app
    'bootstrap4',  # For Bootstrap styling
]
